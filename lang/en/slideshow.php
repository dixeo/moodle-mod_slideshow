...
$string['decrease'] = 'Make text smaller';
...
$string['eventslidesreordered'] = 'Slides reordered';
$string['eventslideupdated'] = 'Slide updated';
$string['eventslidevisibilityupdated'] = 'Slide visibility updated';
...
$string['increase'] = 'Make text larger';
...
$string['printintro'] = 'Display slideshow description';
$string['printintroexplain'] = 'Display slideshow description above content?';
