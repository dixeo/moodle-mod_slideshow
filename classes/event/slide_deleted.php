...
/**
 * The mod_slideshow slide deleted event.
 *
...
/**
 * The mod_slideshow slide deleted event class.
 *
 * @package    mod_slideshow
 * @copyright  2026 Josemaria Bolanos <admin@mako.digital>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class slide_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' deleted the slide with id '{$this->objectid}' for the slideshow with " .
    ...
    public static function get_name() {
        return get_string('eventslidedeleted', 'mod_slideshow');
    }
