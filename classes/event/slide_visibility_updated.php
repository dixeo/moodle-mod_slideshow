...
/**
 * The mod_slideshow slide visibility updated event.
 *
...
/**
 * The mod_slideshow slide visibility updated event class.
 *
 * @package    mod_slideshow
 * @copyright  2026 Josemaria Bolanos <admin@mako.digital>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class slide_visibility_updated extends \core\event\base {
    /**
     ...
     * @return slide_visibility_updated
     */
    public static function create_from_slide(\stdClass $slideshow, \context_module $context, \stdClass $slide) {
        ...
        /** @var slide_visibility_updated $event */
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' updated visibility for the slide with id '{$this->objectid}' " .
            "for the slideshow with course module id '{$this->contextinstanceid}'.";
    }
    ...
    public static function get_name() {
        return get_string('eventslidevisibilityupdated', 'mod_slideshow');
    }
