...
/**
 * The mod_slideshow slides reordered event.
 *
...
/**
 * The mod_slideshow slides reordered event class.
 *
 * @package    mod_slideshow
 * @copyright  2026 Josemaria Bolanos <admin@mako.digital>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class slides_reordered extends \core\event\base {
    /**
     * Create an instance of this event.
     *
     * @param \stdClass $slideshow Slideshow activity record.
     * @param \context_module $context Module context.
     * @param \stdClass $slide Slide that was moved.
     * @return slides_reordered
     */
    ...
    public function get_description() {
        return "The user with id '{$this->userid}' reordered slides for the slideshow with course module id " .
            "'{$this->contextinstanceid}' (moved slide id '{$this->objectid}').";
    }
    ...
    public static function get_name() {
        return get_string('eventslidesreordered', 'mod_slideshow');
    }
